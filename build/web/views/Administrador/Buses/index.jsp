...
<html>
    ...
    <body>
                        ...
                        <c:forEach items="${conductores}" var="conductor">
                            ...
                            <td>${conductor
                                ...
                                <td>
                                    ...
                                    <a alt="Editar usuario" title="Editar" href="<%=request.getContextPath()%>/Administrador/Buses/edit.jsp id=${conductor.conductorId}" class="btn btn-warning btn-xs">
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <a href="<%=request.getContextPath()%>/Administrador/Buses/create.jsp" class="btn btn-success pull-right" style="margin: 20px 0;">Crear nuevo</a> 
            </div>
        </div>
