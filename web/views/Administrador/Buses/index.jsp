        ...
        <div class="col-md-12">
            <div class="table-responsive">
                <table class="table table-striped table-condensed" 
                    ...
                    <thead>
                        <a href="<%=request.getContextPath()%>/views/Administrador/Buses/create.jsp" class="btn btn-success pull-left" style="margin: 20px 0;">Crear nuevo</a> 
                        ...
                        <c:forEach items="${conductores}" var="conductor">
                            ...
                            <td>${conductor
                                ...
                                <td>
                                    ...
                                    <a alt="Editar usuario" title="Editar" href="<%=request.getContextPath()%>/views/Administrador/Buses/edit.jsp id=${conductor.conductorId}" class="btn btn-warning btn-xs">
