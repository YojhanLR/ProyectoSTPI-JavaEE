...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="col-md-4">
                <h1>Editar Transfer</h1>
                <form method="post" action="<%= request.getContextPath()%>/Transfer/update?id=${transfer.transferId}">
                    
                    <div class="col-md-12 form-group">
                        <label for="matricula">Matricula: </label>
                        <input id="matricula" value="${transfer.matricula}" name="matricula" type="text" class="form-control" required=""></input>
                    </div>
                    ...
                    <div class="col-md-12 form-group">
                        ...
                        <c:choose>
                            <c:when test="${transfer.estado eq 'Libre'}">
                                <p class="midsize no-margin"><span class="label label-success" alt="${transfer.estado}">${transfer.estado}</span></p>
                            </c:when>
                            <c:otherwise>
                                <p class="midsize no-margin"><span class="label label-danger" alt="${transfer.estado}">${transfer.estado}</span></p>
                            </c:otherwise>
                        </c:choose>
                    </div>
                    ...
                    <div class="col-md-12 form-group">
                        ...
                        <input id="ubicacion" value="${transfer.ubicacion}" name="ubicacion" type="text" class="form-control" required=""></input>
                    </div>

                    <hr/>

                    <div class="col-md-12 form-group">
                        <input type="submit" value="Editar Transfer" class="btn btn-primary"></input>
                    </div>
                </form>
            </div>
        </div>
