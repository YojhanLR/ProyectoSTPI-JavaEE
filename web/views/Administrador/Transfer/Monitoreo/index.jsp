...
<html>
    <head>
        ...
        <title>Monitoreo de Transfer</title>
    ...
    <body>
            ...
            <div class="panel-body">
                ...
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane fade active in" id="RutaA">
                        ...
                        <jsp:include page='/views/Administrador/Transfer/Monitoreo/table.jsp'>
        ...
        <script src="${pageContext.request.contextPath}/views/Administrador/js/scriptsimulacion_transfer.js"></script>
