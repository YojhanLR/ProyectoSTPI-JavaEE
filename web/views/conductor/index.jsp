...
<html>
    ...
    <body>
                    ...
                    <tbody>
                        <c:forEach items="${conductores}" var="conductor">
                            <tr>
                                ...
                                <td>
                                    <a alt="Editar usuario" title="Editar" href="<%=request.getContextPath()%>/Conductor/Edit?id=${conductor.conductorId}" class="btn btn-warning btn-xs">
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <a href="<%=request.getContextPath()%>/Conductor/Create" class="btn btn-success pull-right" style="margin: 20px 0;">Registrar nuevo usuario</a> 
            </div>
        </div>
