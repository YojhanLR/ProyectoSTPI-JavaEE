<%-- 
   ...
   <header>
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <img class="img-responsive" src="views/Cliente/img/logo.png" alt="">
                <div class="intro-text">
                    <span class="name">Sistema de Transporte Publico Integrado</span>
                    <hr class="star-light">
            ...
            <div class="col-lg-8 col-lg-offset-2">
                ...
                <form name="sentMessage" id="ReservarTransfer" novalidate>
                    ...
                    <div class="row control-group">
                        ...
                        <label for="select" class="col-lg-2 control-label">Ruta</label>
                        <div class="col-lg-10">
