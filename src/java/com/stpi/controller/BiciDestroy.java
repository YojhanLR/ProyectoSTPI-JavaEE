 ...
 * @author HECTOR
 */
@WebServlet(name = "BiciDestroy", urlPatterns = {"/BiciDestroy"})
public class BiciDestroy extends HttpServlet {
    @EJB
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Bicicleta bici = bicicletaFacade.find(id);
        bicicletaFacade.remove(bici);
