 ...
 * @author HECTOR
 */
@WebServlet(name = "TransferDestroy", urlPatterns = {"/TransferDestroy"})
public class TransferDestroy extends HttpServlet {
    @EJB
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       int id = Integer.parseInt(request.getParameter("id"));
        ...
        Transfer transfers = transferFacade.find(id);
        transferFacade.remove(transfers);
